    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Quản lý giấy từ kho</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Trang chủ</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Giấy từ kho</li>
                    </ol>
                </div>
            ...
            <div class="row row-sm">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Thông tin giấy tờ kho</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table border text-nowrap text-md-nowrap table-hover mb-0" id="sell-datatable">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Name</th>
